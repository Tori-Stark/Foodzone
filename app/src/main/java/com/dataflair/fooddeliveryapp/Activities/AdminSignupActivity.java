...
//extract values into variables from the layout file
        ...
        register_button = findViewById(R.id.GoogleSignUpBtn);
                        ...
                        if (task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("admin")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if(task.isSuccessful()){
                                        Toast.makeText(AdminSignupActivity.this,"Sign Up Successful. Check Your Email To Verify Your Account. ",Toast.LENGTH_LONG).show();
                                        ...
                                        Toast.makeText(AdminSignupActivity.this,"Sign Up Unsuccessful. Try Again",Toast.LENGTH_LONG).show();
